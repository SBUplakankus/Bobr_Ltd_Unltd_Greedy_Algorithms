...
| **Coin change** | sorts coin change | Selects the largest possible coin denomination first to minimize the total number of coins needed to make the target amount |
